...
import airplane.service.App;
import airplane.service.Constants;
...
public class AppServer {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, URISyntaxException {
        System.out.println("\"Airplanes\" Jersey Example Application");
        ...
        System.out.println("Application started.\n"
                + "Try accessing " + getBaseURI(Constants.BASE_URI, Constants.PORT, Constants.APPLICATION_PATH, Constants.AIRPLANES_SERVICE_PATH) +" in the browser.\n");
