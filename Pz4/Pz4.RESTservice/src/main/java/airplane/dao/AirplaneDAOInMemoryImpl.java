...
import airplane.dao.dbtable.DBTable;
import airplane.dao.dbtable.DBTableFactory;
import airplane.dao.dbtable.Filter;
import airplane.entity.Airplane;
import airplane.entity.Ticket;
import airplane.entity.Passenger;
...
public class AirplaneDAOInMemoryImpl implements AirplaneDAO {
    ...
    public void addTicket(Ticket ticket) {
        ...
        try {
            airplane = this.airplanes.get(ticket.getAirplaneId());
            airplane.getTicket().add(ticket);
            this.airplanes.update(ticket.getAirplaneId(), airplane);
