...
public class StaxParser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Airplane> airplanes = parser.parse(new FileInputStream(Const.XML_FILE));
        System.out.println("====================================");
        System.out.println("Here is the airplanes: \n" + airplanes);
        System.out.println("====================================");
        airplanes = parser.parse(new FileInputStream(Const.INVALID_XML_FILE));
        System.out.println("====================================");
        System.out.println("Here is the invalid airplanes: \n" + airplanes);
        System.out.println("====================================");
    }

    private List<Airplane> parse(InputStream in) throws XMLStreamException {
