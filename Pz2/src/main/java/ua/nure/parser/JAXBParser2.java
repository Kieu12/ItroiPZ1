...
public class JAXBParser2 {
	...
	public static void main(String[] args) throws JAXBException, FileNotFoundException, SAXException {
		...
		Airplane airplane = airplanes.getAirplane().get(0);
...
//		marshaller.setProperty(null, schemaFactory);
		...
		JAXBElement<Airplane> jarticle = new JAXBElement<>(
				new QName(Const.AIRPLANES_NAMESPACE_URI, "airplane"),
				Airplane.class, airplane);

		marshaller.marshal(jarticle, new File("oneAirplane.xml"));
	}
}